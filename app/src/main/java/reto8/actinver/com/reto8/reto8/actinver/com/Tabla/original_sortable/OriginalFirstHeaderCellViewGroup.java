 ...
 */
public class OriginalFirstHeaderCellViewGroup extends FrameLayout implements TableFixHeaderAdapter.FirstHeaderBinder<ItemSortableCheckBox> {
    ...
    public void bindFirstHeader(final ItemSortableCheckBox item) {
       ...
       /* cb_order_sections_asc.setVisibility(INVISIBLE);
